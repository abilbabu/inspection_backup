...
class BasicInspectionPreview extends StatefulWidget {
  final int jobId;

  const BasicInspectionPreview({super.key, required this.jobId});

  @override
  State<BasicInspectionPreview> createState() => _BasicInspectionPreviewState();
}

class _BasicInspectionPreviewState extends State<BasicInspectionPreview> {
  @override
  void initState() {
    super.initState();
