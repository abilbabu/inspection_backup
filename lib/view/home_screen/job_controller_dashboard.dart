...
class JobControllerDashboard extends StatefulWidget {
  const JobControllerDashboard({super.key});

  @override
  State<JobControllerDashboard> createState() => _JobControllerDashboardState();
}
    ...
    try {
      ...
      final response = await http.post(
        ...
        body: jsonEncode({
          ...
          "userDepartment": 5, // Department 5 for Job Controller
        }),
      );
